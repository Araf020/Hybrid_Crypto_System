...
# It returns (x^y) % p
def modulus_of_exponential(x, y, p):
...
def modulus_of_exponential1(x, y, p):
...
def Use_RSA_encryption(k, iterations):
...
# encryption
public_key, private_key = Use_RSA_encryption(k, 100)
...
# Use_RSA_encryption("hi",k, iterations)
